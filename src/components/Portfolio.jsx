...
import img3 from "../assets/cryptoWebsite.png"
import img4 from "../assets/E-comerceWebsite.png"
import img5 from "../assets/foodWebsite.png"
import img6 from "../assets/LoginPage.png"
import img7 from "../assets/E-Commerce_React.png"
import img8 from "../assets/project_6.png"
      ...
      <section className="section portfolio bg-white">
        ...
        <div className="tab-box">
          <div className="tab-list portfolio-list">
            <button
              className={`  flex-1 py-2 font-medium ${activePortfolio === "MyWork"
          ...
          <div className="tab-list portfolio-list">
            <button
              className={`  flex-1 py-2 font-medium ${activePortfolio === "MyService"
                ? "border-b-4 border-cyan-400  bg-cyan-400 text-black h-[100%] rounded-[5px]"
                : ""
                }`}
        ...
        <div className="tab-wrapper">
          ...
          {activePortfolio === "MyWork" && (
            <div className="tab-grid portfolio-box work">
              ...
              ].map(([img, , project, lang, priview, github], idx) => (
